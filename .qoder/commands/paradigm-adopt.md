...
```python
from _template_loader import detect_local_template

template_path = detect_local_template()
# Returns local QoderTemplate path or None; used in Phase 3 for shutil.copy2
```
